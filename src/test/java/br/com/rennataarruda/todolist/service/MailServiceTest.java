...
class MailServiceTest {
    ...
    void shouldReturnFalseWhenThereIsNoActiveEmailConfig() {
        TestableMailService service = new TestableMailService(emailConfigService, mailSender);
    ...
    void shouldSendPasswordResetWithActiveEmailConfig() throws Exception {
        ...
        assertThat(message.getSubject()).isEqualTo("Redefinicao de senha");
    ...
    void shouldCreateMailSenderFromConfig() {
        MailService service = new MailService(emailConfigService);

        JavaMailSenderImpl sender = (JavaMailSenderImpl) service.createMailSender(activeConfig());
    ...
    private static class TestableMailService extends MailService {
        ...
        private TestableMailService(EmailConfigService emailConfigService, JavaMailSender mailSender) {
